...
EXPECTED_ISO27001_REQUIREMENTS = {
    ...
    "gcp_kms_keys_without_rotation_policy": {"8.24"},
    ...
    "aws_rds_automated_backups_disabled": {"8.13"},
    "aws_security_hub_configuration_gaps": {"8.8", "8.16"},
    "database_instance_exposed": {"8.20"},
    "databricks_ip_access_list_allows_all": {"8.20"},
    "databricks_pat_never_expires": {"5.17"},
    "databricks_public_delta_sharing_recipient": {"8.3"},
    "delegation_boundary_modifiable": {"5.18", "8.2"},
    "device_malware_protection_gaps": {"8.1", "8.8"},
    "device_management_gaps": {"8.1", "8.9"},
    "device_security_posture_gaps": {"8.1", "8.9"},
    "device_update_gaps": {"8.1", "8.8"},
    "eol_software": {"8.8"},
    "guardduty_active_threat": {"8.16"},
    "iam_role_external_account_trust": {"5.18", "8.2"},
    ...
    "serverless_workload_exposed": {"8.20"},
