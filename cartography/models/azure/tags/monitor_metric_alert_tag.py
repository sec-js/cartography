...
class MonitorMetricAlertToTagRelProperties(CartographyRelProperties):
...
class MonitorMetricAlertToTagRel(CartographyRelSchema):
    ...
    properties: MonitorMetricAlertToTagRelProperties = (
        MonitorMetricAlertToTagRelProperties()
    )
