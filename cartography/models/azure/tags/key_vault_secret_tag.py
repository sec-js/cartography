...
class KeyVaultSecretToTagRelProperties(CartographyRelProperties):
...
class KeyVaultSecretToTagRel(CartographyRelSchema):
    ...
    properties: KeyVaultSecretToTagRelProperties = KeyVaultSecretToTagRelProperties()
