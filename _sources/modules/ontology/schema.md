...
> **Implementations**: `AWSAccountAccessKey`, `AnthropicApiKey`, `GCPApiKey`, `GCPServiceAccountKey`, `GitHubPersonalAccessToken`, `ModalApiToken`, `ModalProxyToken`, `OpenAIAdminApiKey`, `OpenAIApiKey`, `RailwayApiToken`, `RailwayProjectToken`, `ScalewayApiKey`, `SubImageAPIKey`, `SupabaseApiKey`, `WorkOSAPIKey`, `WorkOSApplicationClientSecret`.
...
> **Implementations**: `AWSECSCluster`, `AWSEKSCluster`, `AWSEMRCluster`, `AzureKubernetesCluster`, `GKECluster`, `KubernetesCluster`, `ScalewayKapsuleCluster`.
...
- `(:LoadBalancer)-[:EXPOSE]->(:ComputeInstance)`: generated by analysis job `Azure LB EXPOSE relationships`.
  - Properties:
...
- `(:LoadBalancer)-[:EXPOSE]->(:ComputePod)`: generated by analysis job `Kubernetes LoadBalancer to pod EXPOSE relationships`.
  - Properties:
...
> **Implementations**: `AWSECSService`, `GCPCloudRunJob`, `GCPCloudRunService`, `KubernetesCronJob`, `KubernetesDaemonSet`, `KubernetesDeployment`, `KubernetesJob`, `KubernetesStatefulSet`, `ModalApp`, `NetlifySite`, `RailwayServiceInstance`, `ScalewayServerlessContainer`.
...
> **Implementations**: `AWSECSContainer`, `AzureContainerInstance`, `GCPCloudRunJobContainer`, `GCPCloudRunServiceContainer`, `KubernetesContainer`, `ModalSandbox`, `RailwayDeployment`, `ScalewayServerlessContainer`.
...
- `(:LoadBalancer)-[:EXPOSE]->(:Container)`: generated by analysis job `AWS LoadBalancer to ECS Container direct relationship`, `Kubernetes LoadBalancer to container EXPOSE relationships`.
  - Properties:
...
> **Implementations**: `AWSECRRepository`, `GCPArtifactRegistryRepository`, `GitHubPackage`, `GitLabContainerRepository`, `ScalewayContainerRegistryNamespace`.
...
> **Implementations**: `AWSInspectorFinding`, `CVE`, `CrowdstrikeFinding`, `GitHubDependabotAlert`, `S1AppFinding`, `SemgrepSCAFinding`, `TenableFinding`, `TrivyImageFinding`, `UbuntuCVE`.
...
> **Implementations**: `AWSDNSRecord`, `CloudflareDNSRecord`, `GCPRecordSet`, `NetlifyDNSRecord`, `ScalewayDnsRecord`, `SupabaseCustomHostname`, `VercelDNSRecord`.
...
> **Implementations**: `AWSEfsFileSystem`, `AzureStorageFileShare`, `ModalNetworkFileSystem`, `ModalVolume`, `ScalewayFileSystem`.
...
> **Implementations**: `AWSLambda`, `AzureFunctionApp`, `CloudflareWorkerScript`, `GCPCloudFunction`, `ModalFunction`, `NetlifyFunction`, `ScalewayServerlessFunction`, `SupabaseEdgeFunction`.
...
> **Implementations**: `AWSSAMLProvider`, `GCPWorkloadIdentityProvider`, `KeycloakIdentityProvider`, `KubernetesOIDCProvider`, `SupabaseSSOProvider`, `SupabaseThirdPartyAuthIntegration`.
...
> **Implementations**: `AWSECRImage`, `GCPArtifactRegistryImage`, `GitHubContainerImage`, `GitLabContainerImage`, `ScalewayContainerRegistryImage`.
...
> **Implementations**: `AWSEC2SecurityGroup`, `AzureFirewall`, `AzureNetworkSecurityGroup`, `CloudflareRuleset`, `DatabricksIpAccessList`, `GCPCloudArmorPolicy`, `GCPFirewall`, `ScalewaySecurityGroup`.
...
> **Implementations**: `AWSS3Bucket`, `AzureStorageBlobContainer`, `CloudflareR2Bucket`, `DatabricksExternalLocation`, `DatabricksVolume`, `GCPBucket`, `ScalewayObjectStorageBucket`, `SupabaseStorageBucket`.
...
> **Implementations**: `AWSPermissionSet`, `AWSRole`, `AzureRoleDefinition`, `CloudflareRole`, `GCPRole`, `KeycloakRole`, `KubernetesClusterRole`, `KubernetesRole`, `ModalEnvironmentRole`, `ModalWorkspaceRole`, `OCIPolicy`, `SalesforcePermissionSet`, `SalesforceProfile`, `ScalewayPermissionSet`, `WorkOSRole`.
...
> **Implementations**: `AWSSSMParameter`, `AWSSecretsManagerSecret`, `AzureKeyVaultSecret`, `GCPSecretManagerSecret`, `GitHubActionsSecret`, `KubernetesSecret`, `ModalSecret`, `NetlifyEnvVar`, `RailwayVariable`, `ScalewaySecret`, `SupabaseSecret`.
...
> **Implementations**: `AWSGuardDutyFinding`, `AWSInspectorFinding`, `AzureSecurityAssessment`, `GitHubDependabotAlert`, `SemgrepSASTFinding`, `SemgrepSCAFinding`, `SemgrepSecretsFinding`, `SocketDevAlert`, `SupabaseSecurityAdvisorFinding`.
...
> **Implementations**: `AWSServicePrincipal`, `DatabricksAccountServicePrincipal`, `DatabricksServicePrincipal`, `EntraServicePrincipal`, `GCPServiceAccount`, `KubernetesServiceAccount`, `ModalServiceUser`, `OpenAIServiceAccount`, `ScalewayApplication`.
...
> **Implementations**: `AWSSSOUser`, `AWSUser`, `AirbyteUser`, `AnthropicUser`, `CloudflareMember`, `DatabricksAccountUser`, `DatabricksUser`, `DuoUser`, `EntraUser`, `GSuiteUser`, `GitHubUser`, `GitLabUser`, `GoogleWorkspaceUser`, `JumpCloudUser`, `KeycloakUser`, `KubernetesUser`, `LastpassUser`, `ModalUser`, `NetlifyUser`, `OCIUser`, `OpenAIUser`, `PagerDutyUser`, `RailwayUser`, `SalesforceUser`, `ScalewayUser`, `SentryUser`, `SlackUser`, `SnipeitUser`, `SpaceliftUser`, `SubImageTeamMember`, `SupabaseOrganizationMember`, `TailscaleUser`, `VercelUser`, `WorkOSDirectoryUser`, `WorkOSUser`.
