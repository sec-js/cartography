...
- A canonical **PackageVersion** (ontology) is detected as a **GitHubDependency**.

    ```
    (PackageVersion)-[:DETECTED_AS]->(Dependency:GitHubDependency)
    ```
