...
| private_ip_address | Yes | The private IPv4 address of the network interface. |
| public_ip |  | The public IP address or Elastic IP address bound to the network interface. |

#### Relationships

- `(:AWSLoadBalancerV2)-[:EXPOSE]->(:AWSEC2PrivateIp)`: generated by analysis job `Resolve ELBV2 IP targets to private IP identities`.
  - Properties:

    | Field | Description |
    |-------|-------------|
    | port | Property generated by analysis job: `Resolve ELBV2 IP targets to private IP identities`. |
    | protocol | Property generated by analysis job: `Resolve ELBV2 IP targets to private IP identities`. |
    | target_group_arn | Property generated by analysis job: `Resolve ELBV2 IP targets to private IP identities`. |
...
| cvssvector |  | CVSS vector string for Inspector's adjusted (reachability/exploitability-adjusted) score. |
...
| vendorcvssscores |  | CVSS base scores reported by the vendor/NVD sources for the vulnerability. |
| vendorcvssvectors |  | CVSS scoring vectors reported by the vendor/NVD sources for the vulnerability. |
