...
from cartography.intel.modal.util import list_volumes
from cartography.intel.modal.util import ModalClient
from cartography.models.modal.volume import ModalVolumeSchema
...
def cleanup(
    ...
    GraphJob.from_node_schema(ModalVolumeSchema(), common_job_parameters).run(
        neo4j_session
    )
