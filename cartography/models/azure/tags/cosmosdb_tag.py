...
class CosmosDBAccountToTagRelProperties(CartographyRelProperties):
...
class CosmosDBAccountToTagRel(CartographyRelSchema):
    ...
    properties: CosmosDBAccountToTagRelProperties = CosmosDBAccountToTagRelProperties()
