...
class ApplicationGatewayToTagRelProperties(CartographyRelProperties):
...
class ApplicationGatewayToTagRel(CartographyRelSchema):
    ...
    properties: ApplicationGatewayToTagRelProperties = (
        ApplicationGatewayToTagRelProperties()
    )
