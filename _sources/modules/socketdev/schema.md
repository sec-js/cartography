...
| artifact_namespace |  | Affected package namespace or scope from the Socket.dev artifact.namespace field. |
...
| fullname | Yes | Repository path including its workspace when available; otherwise the repository slug. |
| homepage |  | Repository homepage URL. |
| name | Yes | Repository name. |
| repository_url |  | GitHub.com repository URL from Socket.dev integration metadata. |
