...
class ResourceGroupToTagRelProperties(CartographyRelProperties):
...
class ResourceGroupToTagRel(CartographyRelSchema):
    ...
    properties: ResourceGroupToTagRelProperties = ResourceGroupToTagRelProperties()
